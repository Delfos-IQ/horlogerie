...
const SHELL = [
  `${BASE}/`,
  `${BASE}/index.html`,
  `${BASE}/css/app.css?v=1.9.0`,
  `${BASE}/js/db.js?v=1.9.0`,
  `${BASE}/js/storage.js?v=1.9.0`,
  `${BASE}/js/api.js?v=1.9.0`,
  `${BASE}/js/sync.js?v=1.9.0`,
  `${BASE}/js/export.js?v=1.9.0`,
  `${BASE}/js/modules/core.js?v=1.9.0`,
  `${BASE}/js/modules/home-detail.js?v=1.9.0`,
  `${BASE}/js/modules/modals.js?v=1.9.0`,
  `${BASE}/js/modules/history.js?v=1.9.0`,
  `${BASE}/js/modules/settings.js?v=1.9.0`,
  `${BASE}/js/modules/wishlist.js?v=1.9.0`,
  `${BASE}/js/modules/session.js?v=1.9.0`,
  `${BASE}/js/modules/updates.js?v=1.9.0`,
  `${BASE}/js/modules/url-import.js?v=1.9.0`,
  `${BASE}/manifest.json`,
